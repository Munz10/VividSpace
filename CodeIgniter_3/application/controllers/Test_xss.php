...
class Test_xss extends MY_Controller {

    public function __construct() {
        parent::__construct();

        // Sandbox / dev aid only. test_unsafe_output deliberately reflects
        // unescaped input - must never be reachable in production.
